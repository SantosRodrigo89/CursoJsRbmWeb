...
const blusas = [
  ...
  },
  {
    id: 6,
    imagem:
      "https://img.elo7.com.br/product/zoom/2BE216B/caneca-personalizada-quero-cafe-ceramica.jpg",
  ...
  },
  {
    id: 7,
    imagem:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTP6t4R0N8xWJfGY6v75sj2G071mDlByfSqtw&usqp=CAU",
    titulo: "Café de Itu",
    categoria: "Nacional",
    pais: "Brasil",
    preco: "5,00",
...
function search() {
  ...
  const filterTypeValue = (searchTypeElement as HTMLSelectElement).value as
    ...
    | "quantidade"
    | "preco";
  const newBlusas = blusas.filter((blusa) =>
    blusa[filterTypeValue].includes(searchInputValue)
  );
  render(newBlusas);
}
